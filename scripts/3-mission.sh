...
--tab -e 'bash -c "sleep 3; source ~/abot_ws/devel/setup.bash; rosrun robot_voice tts_subscribe; exec bash"' \
--tab -e 'bash -c "sleep 4; source ~/abot_ws/devel/setup.bash; roslaunch robot_slam multi_goal.launch; exec bash"' \
